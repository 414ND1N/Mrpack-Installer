import Gt, { app as Sn, BrowserWindow as fm, ipcMain as qt } from "electron";
...
const rr = qa.homedir(), Iu = qa.tmpdir(), { env: Mr } = Ye, yg = (e) => {
...
}, $g = Ye.getuid ? !Ye.getuid() : !1, wg = 1e4, ht = () => {
}, Be = {
  /* API */
  isChangeErrorOk: (e) => {
    if (!Be.isNodeError(e))
...
const bg = new Eg(), Jt = (e, t) => function(a) {
  return function h(...r) {
...
var Fn = { exports: {} }, oo = {}, jt = {}, fr = {}, so = {}, uo = {}, co = {}, gc;
function Ca() {
...
function Va() {
  ...
  const e = Fg(), t = Ia(), u = wm(), a = Ia(), h = jg(), r = Ug(), n = Lg(), s = Re(), i = Tt(), c = xa(), o = qe(), p = La();
  function d(C) {
    if (S(C) && (w(C), b(C))) {
      f(C);
      return;
...
function Ha() {
  ...
  const e = Re(), t = ku(), u = Tt(), a = xa(), h = qe(), r = Va();
  class n {
    constructor(m) {
      var l;
...
function qu() {
  ...
  const e = Ba(), t = Ot(), u = Re(), a = Tt(), h = Ha(), r = qe(), n = {
    keyword: "$ref",
    schemaType: "string",
    code(c) {
...
var _o = {}, Ii = { exports: {} }, $o = {}, Mt = {}, pr = {}, wo = {}, Eo = {}, bo = {}, Gl;
function Da() {
...
function Ka() {
  ...
  const e = s_(), t = ka(), u = Am(), a = ka(), h = u_(), r = c_(), n = l_(), s = Ie(), i = ir(), c = za(), o = Fe(), p = Ga();
  function d(C) {
    if (S(C) && (w(C), b(C))) {
      f(C);
      return;
...
function Lu() {
  ...
  const e = Ie(), t = Uu(), u = ir(), a = za(), h = Fe(), r = Ka();
  class n {
    constructor(m) {
      var l;
      this.refs = {}, this.dynamicAnchors = {};
...
function E_() {
  ...
  const e = Wa(), t = At(), u = Ie(), a = ir(), h = Lu(), r = Fe(), n = {
    keyword: "$ref",
    schemaType: "string",
    code(c) {
      const { gen: o, schema: p, it: d } = c, { baseId: y, schemaEnv: $, validateName: v, opts: f, self: m } = d, { root: l } = $;
...
function Ct() {
  ...
  rs = t;
  const u = q$(), a = new u(), h = xu(), r = Qa(), n = Ja(), s = ct(), {
    safeRe: i,
    t: c,
...
function Qa() {
  ...
  ns = t;
  const u = xu(), { safeRe: a, t: h } = Tn(), r = Fm(), n = Ja(), s = ct(), i = Ct();
  return ns;
}
var is, Fd;
function Za() {
...
function zu() {
  if (Vd) return ls;
  Vd = 1;
  const e = ct(), t = Qa(), { ANY: u } = t, a = Ct(), h = Za(), r = Xa(), n = Bu(), s = Gu(), i = Hu();
  return ls = (o, p, d, y) => {
...
function G$() {
  if (Kd) return ms;
  Kd = 1;
  const e = Ct(), t = Qa(), { ANY: u } = t, a = Za(), h = Nt(), r = (p, d, y = {}) => {
    if (p === d)
      return !0;
...
function Ku() {
  if (Wd) return ys;
  Wd = 1;
  const e = Tn(), t = Ya(), u = ct(), a = Dm(), h = Vr(), r = E$(), n = b$(), s = S$(), i = P$(), c = R$(), o = T$(), p = O$(), d = A$(), y = Nt(), $ = N$(), v = C$(), f = Vu(), m = I$(), l = D$(), g = Xa(), b = Bu(), S = km(), _ = qm(), w = Hu(), R = Gu(), T = Fm(), M = k$(), F = Qa(), j = Ct(), V = Za(), U = F$(), z = j$(), W = U$(), Q = L$(), ee = M$(), ne = zu(), K = x$(), I = V$(), G = B$(), D = H$(), P = G$();
  return ys = {
    parse: h,
    valid: r,
    clean: n,
...
const { app: Na, ipcMain: Ou, shell: ow } = Gt;
let Zd = !1;
const eh = () => {
  if (!Ou || !Na)
...
function ft() {
  if (ah) return va;
  ah = 1;
  var e = nr, t = uw(), u = cw(), a = lw(), h = Nu, r, n;
...
function eo() {
  if (gh) return Is;
  gh = 1;
  const e = ft(), t = gt().fromCallback, u = /* @__PURE__ */ mw();
  function a(r, n) {
...
function Ow() {
  if (Ih) return Ks;
  Ih = 1;
  const e = ft(), t = Ge, u = Wu().copy, a = eo().remove, h = It().mkdirp, r = br().pathExists, n = /* @__PURE__ */ Hr();
  function s(d, y, $, v) {
    typeof $ == "function" && (v = $, $ = {}), $ = $ || {};
...
function Aw() {
  if (Dh) return Ws;
  Dh = 1;
  const e = ft(), t = Ge, u = Wu().copySync, a = eo().removeSync, h = It().mkdirpSync, r = /* @__PURE__ */ Hr();
  function n(p, d, y) {
    y = y || {};
...
function jw() {
  ...
  const e = Rn, t = Fw(), u = nr, a = Pn, h = xr, r = Xu(), n = to(), s = xm(), i = (0, t.default)("electron-builder");
  function c(_, w = null) {
...
function Jw() {
  ...
  const e = Rn, t = nr, u = Yw(), a = /* @__PURE__ */ ar(), h = Ge;
  let r = class {
    constructor(c) {
...
function uy() {
  ...
  const e = et(), t = /* @__PURE__ */ ar(), u = nr, a = sy(), h = xr, r = ec(), n = aE(), s = oE();
  let i = class {
...
function tc() {
  ...
  const e = et(), t = Rn, u = ja, a = hm, h = /* @__PURE__ */ ar(), r = Zu(), n = Ww(), s = Ge, i = Ku(), c = Jw(), o = Qw(), p = Zw(), d = ay(), y = iE(), $ = mm, v = Sr(), f = sE(), m = Pr();
...
function Qp() {
  ...
  const e = et(), t = Fa, u = /* @__PURE__ */ ar(), a = nr, h = Ge, r = Gr(), n = ly(), s = $t(), i = Pr();
...
function om() {
  ...
  const e = et(), t = /* @__PURE__ */ ar(), u = nr, a = Ge, h = lg, r = tc(), n = $t(), s = Fa, i = Rn;
...
function cm() {
  ...
  const e = et(), t = Ge, u = Gr(), a = ly(), h = Pr(), r = $t(), n = /* @__PURE__ */ ar(), s = uE(), i = xr;
...
const Ht = new sw(), Au = process.env.VITE_DEV_SERVER_URL, a1 = ke.join(process.env.APP_ROOT, "dist-electron"), fy = ke.join(process.env.APP_ROOT, "dist");
...
Sn.whenReady().then(() => {
  dy(), fE(), console.log("Checking for updates..."), Rt.autoUpdater.checkForUpdates(), console.log("Last version:", Rt.autoUpdater.currentVersion);
});
export {
  a1 as MAIN_DIST,
  fy as RENDERER_DIST,
