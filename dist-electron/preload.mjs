...
electron.contextBridge.exposeInMainWorld("nodeModules", {
  path: {
    join: (...args) => path.join(...args),
  ...
  fs: {
    ...
    writeFile: async (filePath, data, encoding = "utf-8") => {
      return await promises.writeFile(filePath, data, encoding);
    },
    readFileSync: (filePath, encoding = "utf-8") => {
      return require$$6.readFileSync(filePath, encoding);
    },
    existsSync: (filePath) => {
      return require$$6.existsSync(filePath);
    },
    writeFileSync: (filePath, data, encoding = "utf-8") => {
      require$$6.writeFileSync(filePath, data, encoding);
    },
    mkdirSync: (dirPath, options = { recursive: true }) => {
      if (!require$$6.existsSync(dirPath)) {
        require$$6.mkdirSync(dirPath, options);
      }
    }
  },
  axios: {
