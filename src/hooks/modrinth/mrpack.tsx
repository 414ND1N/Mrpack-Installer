...
export const GetMrpackInfo = async (filePath: string): Promise<MrpackInfo> => {
...
export const DownloadMarpackFiles = async (filePath: string, downloadPath: string, downloadType: string = 'singleplayer'): Promise<void> => {
    try {
        console.log('Fetching mrpack metadata from local file:', filePath)
